...
public class Validation {
    ...
    private static final String EMAIL_VALID = "^[\\w-\\.]+@([\\w-]+\\.)+[\\w-]{2,4}$";
    ...
    public static String checkInputUserName() {
        ...
        while (true) {
            ...
            if (result.isEmpty()) {
                ...
                System.out.println("Wrong input format! The username must be at least five characters and no spaces");
    ...
    public static String checkInputPhone() {
        while (true) {
            ...
            if (result.matches(PHONE_VALID)) {
                ...
                System.out.print("Invalid phone format. Phone number must be between 10 and 12 numbers. \nEnter again: ");
            }
        }
    }
    ...
    public static String checkInputEmail() {
        ...
        while (true) {
            ...
            if (result.matches(EMAIL_VALID)) {
                ...
                System.err.println("Email with format error");
                System.out.print("Enter again: ");
            }
        }
    }
    ...
    public static String checkInputPass2() {
        ...
        while (true) {
            ...
            if (result.length() >= 6 && result.matches(PASSWORD_VALID) && !result.contains(" "))
                ...
                System.out.println("Confirm Password is invalid (password must be at least 6 characters and must not have space between: ");
